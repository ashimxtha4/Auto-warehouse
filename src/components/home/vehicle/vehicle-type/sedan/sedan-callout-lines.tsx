  ...
  return (
    <>
      ...
      <div className='absolute'>
        <span className='circle-dot left-[135px] top-[265px]' />
        <span className='vehicle-line left-[137px] top-[268px] w-[153px]' />
        <Link
          href={pathname + '?part=right-mirror'}
          className='absolute left-[18rem] top-[15.7rem] flex items-center text-nowrap rounded-md border-primary-desaturate bg-primary-dark px-2 py-1 text-white hover:bg-primary-main'
        >
          Right Mirror
        </Link>
      </div>
      {/* left mirror */}
      <div className='absolute'>
        <span className='circle-dot -left-[150px] top-[265px]' />
        <span className='vehicle-line -left-[300px] top-[268px] w-[153px]' />
        <Link
          href={pathname + '?part=left-mirror'}
          className='absolute -left-[19rem] top-[15.7rem] flex items-center text-nowrap rounded-md border-primary-desaturate bg-primary-dark px-2 py-1 text-white hover:bg-primary-main'
        >
          Left Mirror
        </Link>
      </div>
      ...
      {/* Back right vent */}
      <div className='absolute'>
        <span className='circle-dot left-[106px] top-[528px]' />
      ...
      {/* Back windshield */}
      <div className='absolute'>
        <span className='circle-dot left-0 top-[630px]' />
        <span className='vehicle-line left-[5px] top-[632px] w-[270px]' />
        <Link
          href={pathname + '?part=back-windshield'}
          className='absolute left-[16.8rem] top-[38.7rem] flex items-center text-nowrap rounded-md border-primary-desaturate bg-primary-dark px-2 py-1 text-white hover:bg-primary-main'
        >
          Back WindShield
        </Link>
      </div>
